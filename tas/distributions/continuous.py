...
# Copied from https://github.com/pytorch/rl/blob/main/torchrl/modules/distributions/continuous.py
...
from tas.distributions.truncated_normal import (
    TruncatedNormal as _TruncatedNormal,
)

# from torchrl._torchrl import safeatanh, safetanh
from tas.distributions.utils import (
    _cast_device,
    FasterTransformedDistribution,
    safeatanh,
    safetanh,
)
import tas.distributions.mappings as mappings
